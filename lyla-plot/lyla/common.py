...
def get_args():
    ...
    group_i.add_argument( '-i', '--input', help='scaffold_info.tsv (arranged from bottom to top)', type=str, nargs='*')
    group_i.add_argument( '--xlsx', help='scaffold_info.xlsx', type=str )
    ...
    parser.add_argument( '--min_alignment_len', help='optional: (default 0)', type=int, default=0 )
    parser.add_argument( '--alignment_height', help='optional: (default 1.5)', type=float, default=1.5 )
    parser.add_argument( '--alignment_alpha', help='optional: (default 0.5)', type=float, default=0.5 )
    ...
    parser.add_argument( '--gff3', help='gff3 files', type=str, nargs='*' )
    parser.add_argument( '--gff_xlsx', help='excel files', type=str, nargs='*' )
    parser.add_argument( '--gene_thickness', help='optional: (default 3)', type=float, default=3 )
    parser.add_argument( '--gene_font_size', help='optional: (default 0)', type=float, default=0 )
    parser.add_argument( '--gene_font_rotation', help='optional: (default 0)', type=float, default=0 )
    parser.add_argument( '--gene_color', help='optional: (default black)', type=str, default='black' )
    parser.add_argument( '--gene_edge_color', help='optional: same means same as fill color  (default black)', type=str, default='black' )
    ...
    parser.add_argument('--scaffold_color', help='optional: (default grey)', default='grey', type=str )
    ...
    parser.add_argument( '--figure_size', help='optional: (default [8,6])', type=float, nargs='*', default=[8,6] )
    parser.add_argument( '--seq_thickness', help='optional: (default 0.1)', type=float, default=0.1 )
...
class Size:
    def __init__( self, seqs, margin_bw_scaffolds, xlim_max, alignment_height, size, seq_thickness, gene_thickness ):
        ...
        self.top_margin = 0.5
        self.ylim_max = 5
        self.figsize_inch = size
        self.margin_bw_scaffold_alignment = 0.12
        #self.margin_bw_scaffold_alignment = seq_thickness * gene_thickness * 0.6
